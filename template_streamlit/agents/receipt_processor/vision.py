...
from template_streamlit.agents.receipt_processor.models import ReceiptOCRResult
...
def ocr_receipt(image_path: str) -> ReceiptOCRResult:
    """
    ...
    try:
        ...
        # OCR処理を実行
        result: ReceiptOCRResult = ocr_chain.invoke(build_vision_message(processed_image_path))  # type: ignore
