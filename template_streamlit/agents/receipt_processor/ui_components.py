...
from template_streamlit.agents.receipt_processor.models import AccountInfo, CommandType, Feedback
...
def handle_image_input() -> str | None:
    """
    ...
    # ファイルアップロード機能
    uploaded_file = st.file_uploader("領収書画像をアップロード", type=["jpg", "jpeg", "png"])
...
def display_action_buttons() -> Feedback | None:
    """
    アクションボタンを表示
    ...
    # 説明文
    st.markdown("自然言語でエージェントにフィードバックを送り、勘定科目情報を再生成できます")
